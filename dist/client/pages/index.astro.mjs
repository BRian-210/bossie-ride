...
const $$Index = createComponent(($$result, $$props, $$slots) => renderTemplate`<html lang="en" data-astro-cid-j7pv25f6>
<head data-source-file="src/pages/index.astro" data-source-line-start="9" data-source-line-end="191">
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title data-source-file="src/pages/index.astro" data-source-line-start="12" data-source-line-end="12">${"Bossie Ride - Get There Fast"}</title>

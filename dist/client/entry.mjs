...
import { c as createExports, s as serverEntrypointModule } from "./_@astrojs-ssr-adapter.B59v7vff.js";
import { manifest } from "./manifest_rpW2QIoe.mjs";
...
const _page15 = () => import("./pages/mpesa-payment-confirmation.astro.mjs");
const _page16 = () => import("./pages/mpesa-payment-details.astro.mjs");
const _page17 = () => import("./pages/payment-failure.astro.mjs");
const _page18 = () => import("./pages/payment-initiation.astro.mjs");
const _page19 = () => import("./pages/payment-success.astro.mjs");
const _page20 = () => import("./pages/placeholder.astro.mjs");
const _page21 = () => import("./pages/profile.astro.mjs");
const _page22 = () => import("./pages/ride-completed.astro.mjs");
const _page23 = () => import("./pages/ride-history.astro.mjs");
const _page24 = () => import("./pages/ride-in-progress.astro.mjs");
const _page25 = () => import("./pages/ride-request.astro.mjs");
const _page26 = () => import("./pages/select-ride-type.astro.mjs");
const _page27 = () => import("./pages/signup.astro.mjs");
const _page28 = () => import("./pages/track-driver.astro.mjs");
...
const pageMap = /* @__PURE__ */ new Map([
  ...
  ["src/pages/mpesa-payment-confirmation.astro", _page15],
  ["src/pages/mpesa-payment-details.astro", _page16],
  ["src/pages/payment-failure.astro", _page17],
  ["src/pages/payment-initiation.astro", _page18],
  ["src/pages/payment-success.astro", _page19],
  ["src/pages/placeholder.astro", _page20],
  ["src/pages/profile.astro", _page21],
  ["src/pages/ride-completed.astro", _page22],
  ["src/pages/ride-history.astro", _page23],
  ["src/pages/ride-in-progress.astro", _page24],
  ["src/pages/ride-request.astro", _page25],
  ["src/pages/select-ride-type.astro", _page26],
  ["src/pages/signup.astro", _page27],
  ["src/pages/track-driver.astro", _page28],
